...
var CenterBlock = React.createClass({
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "large-8 columns large-centered about-us" },
      React.createElement(
        "h3",
        null,
        this.props.message
      ),
      this.state.showResults ? React.createElement(AboutUs, { toggle: this.toggleForm }) : React.createElement(SignUpForm, { toggle: this.toggleForm })
    );
  }
});
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "p",
        null,
        " Choose your destination, and we will create your trip! We will find you Hotels, Resturaunts, Events, and other activities to make your trip the best ever! Create, Plan, and Ride!"
      ),
      React.createElement(
        "div",
        { className: "button-group landing-buttons centered" },
        React.createElement(
          "button",
          { className: "small-4", onClick: this.props.toggle },
          " Sign Up "
        ),
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "large-10 small-centered columns" },
            React.createElement(
              "div",
              ...
              React.createElement(
                ...
                React.createElement("span", { href: "#", className: "prefix fi-torso" })
              ),
              React.createElement(
                "div",
                { className: "small-10 columns" },
                React.createElement("input", { id: "email", type: "email", placeholder: "email", name: "user[email]" })
              )
            )
          )
        ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "small-2 columns" },
                React.createElement("span", { href: "#", className: "prefix fi-lock" })
              ),
              React.createElement(
                "div",
                { className: "small-10 columns" },
                React.createElement("input", { id: "password", type: "password", placeholder: "password", name: "user[password]" })
              )
            )
          )
        ),
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "small-10 columns" },
                React.createElement("input", { id: "password_confirmation", type: "password", placeholder: "confirm password", name: "user[password_confirmation]" })
              )
            )
          )
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "a",
              { href: "#", onClick: this.props.toggle, className: "back-arrow" },
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "small-5 small-centered columns" },
              React.createElement("input", { type: "submit", className: "button small-12", name: "name", value: "Sign Up" })
            )
          )
        )
      )
...
var ModalBitches = React.createClass({
  displayName: "ModalBitches",

  handleClick: function (e) {
    if (e && typeof e.preventDefault == 'function') {
      e.preventDefault();
    }
    var contentDiv = $('<div>' + { SignUpForm: SignUpForm } + '</div>');
...
var PreviewButton = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "button",
        { className: "small-4", onClick: this.handleClick },
        " Preview "
      )
    );
  }
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "ul",
          { className: "right" },
          this.state.showResults ? React.createElement(LogInForm, null) : React.createElement(LogInButton, { onClick: this.toggleForm })
        )
      )
    );
  }
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", placeholder: "email", name: "user[email]" })
      ),
      React.createElement(
        "li",
        { className: "login-form" },
      ...
      React.createElement(
        "li",
        { className: "login-form" },
        React.createElement("input", { className: "button small", type: "submit", value: "Login!" })
      )
    );
  }
});
...
var logoutNavbar = React.createClass({
  displayName: "logoutNavbar",

  render: function () {
    return React.createElement(
      "nav",
      { className: "top-bar", "data-topbar": "", role: "navigation" },
      React.createElement(
        "ul",
        { className: "title-area" },
        React.createElement(
...
var SettingsButtons = React.createClass({
  ...
  doStuff: function () {
    ...
    $.post('/users/' + window.location.pathname.split('/')[2], { 'user[name]': name, 'user[hometown_city]': hometown_city, 'user[hometown_state]': hometown_state, "_method": "patch" }).done(function (data) {});
  ...
  render: function () {
    return React.createElement(
      "div",
      { className: "profile-settings small-12 columns" },
      React.createElement(
        "div",
        { className: "small-12 columns edit-pencil" },
        React.createElement(
          "a",
          { href: "#" },
          React.createElement("i", { id: "edit-intro", className: "fi-pencil edit-profile", onClick: this.toggleForm })
        )
      ),
      React.createElement(
        "div",
        { className: "small-12 columns" },
        this.state.showResults ? React.createElement(ProfileInfo, { miles: this.state.miles, name: this.state.name, hometown_city: this.state.hometown_city, hometown_state: this.state.hometown_state, trips: this.state.trips }) : React.createElement(EditProfileInfo, { onClick: this.doStuff, name: this.state.name, hometown_city: this.state.hometown_city, hometown_state: this.state.hometown_state, trips: this.state.trips })
      )
    );
  }
});
...
var ProfileInfo = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      "div",
      null,
      React.createElement("img", { className: "profile-pic", src: "http://images.amcnetworks.com/sundancechannel.com/wp-content/uploads/2013/09/fear-and-loathing-in-las-vegas.jpg", alt: "" }),
      React.createElement(
        "h2",
        null,
        "Hello, ",
        this.props.name ? this.props.name : "roadtripper",
        "!"
      ),
      React.createElement(
        "p",
      ...
      React.createElement(
        ...
        null,
        " Hometown: ",
        this.props.hometown_city ? this.props.hometown_city : "Somewhere",
        ", ",
        this.props.hometown_state ? this.props.hometown_state : "USA"
      )
    );
  }
});
var EditProfileInfo = React.createClass({
  displayName: "EditProfileInfo",
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: "#", className: "medium" },
          React.createElement("i", { className: "fi-camera" })
        )
      ),
      React.createElement(
        "div",
        ...
        React.createElement(
          "div",
          { className: "large-12 small-centered columns" },
          React.createElement(
            "div",
            { className: "row collapse" },
            React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("input", { id: "editName", type: "text", placeholder: this.props.name, name: "user[name]" })
            )
          )
        )
      ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("input", { id: "editHometown_city", type: "text", placeholder: this.props.hometown_city, placeholder: "City", name: "user[hometown]" })
            ),
            React.createElement(
              "div",
              { className: "small-5 columns" },
              React.createElement("input", { id: "editHometown_state", type: "text", placeholder: this.props.hometown_state, placeholder: "State", name: "user[hometown]" })
            )
          )
        )
      ),
      React.createElement(
        ...
        React.createElement(
          "button",
          { className: "button small", id: "editProfileButton", value: "Update Profile", onClick: this.props.onClick },
          "Update Profile"
        )
      ),
      React.createElement(
        ...
        React.createElement(
          "a",
          { href: '/users/' + window.location.pathname.split('/')[2], "data-method": "delete", rel: "nofollow", className: "delete" },
          "Delete Account"
        )
      )
    );
...
var NewTripButton = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "button",
        { "class": "new-trip button tiny", onClick: this.handleClick },
        React.createElement("span", { className: "fi-plus" }),
        " Create New Trip"
      )
    );
  }
...
var GetTiles = React.createClass({
  ...
  render: function () {
    ...
    for (var i = 0; i < trips.length; i++) {
      allTrips.push(React.createElement(TripTile, { key: trips[i].id, data: trips[i] }));
    }
    ...
    return React.createElement(
      ...
      React.createElement(
        "ul",
        { className: "button-group even-1" },
        React.createElement(
          "li",
          { onClick: this.sortByProp },
          React.createElement(
            "a",
            { className: "tiny button", href: "#" },
            this.state.sortProp
          )
        ),
        React.createElement(
      ...
      React.createElement(
        "ul",
        { className: "polaroids large-12 columns" },
        allTrips
      )
    );
  }
...
var TripTile = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: this.props.data.finished ? "finished" : undefined },
        React.createElement(
          "a",
          { href: '/users/' + window.location.pathname.split('/')[2] + '/trips/' + this.props.data.id },
          React.createElement("img", { src: "http://www.usnews.com/dims4/USNEWS/e4ce14a/2147483647/resize/652x%3E/quality/85/?url=%2Fcmsmedia%2F2e%2Fc1%2F90572c4e46c997c90ff60b17be58%2F140624-summerroadtrip-stock.jpg", alt: "" }),
          React.createElement(
            "p",
            { className: "trip-name" },
        ...
        React.createElement(
          "p",
          { className: "trip-name" },
          this.props.data.finished ? "(finished)" : null
        )
      )
    );
  }
...
var TripDashboard = React.createClass({
  ...
  newBlogPost: function () {
    ...
    $.post('/users/' + window.location.pathname.split('/')[2] + '/trips/' + window.location.pathname.split('/')[4] + '/posts', { 'post[latitude]': latitude, 'post[longitude]': longitude, 'post[title]': title, 'post[content]': content, "_method": "post" }).done(function (data) {});
    this.blogs();
    this.getTripInfo();
    this.onClick();
  },
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        'ul',
        { className: 'tabs', 'data-tab': true },
        React.createElement(
          'li',
          { className: 'tab-title small-4 active' },
          React.createElement(
            'a',
            { href: '#panel1', onClick: this.itinerary },
            'Itinerary'
          )
        ),
        React.createElement(
          'li',
          { className: 'tab-title small-4' },
          React.createElement(
            'a',
            { href: '#panel2', onClick: this.blogs },
            'Blog'
          )
        ),
        React.createElement(
          ...
          React.createElement(
            'a',
            { href: '#panel3', onClick: this.activities },
            'Activities'
          )
        )
      ),
      React.createElement(
        'div',
        null,
        this.state.status === 1 ? React.createElement(Itinerary, { finished: this.state.finished, updateTrip: this.getTripInfo, trip: this.state.trip, destinations: this.state.destinations }) : this.state.status === 3 ? React.createElement(Activities, { lat: this.state.lat, long: this.state.long, finished: this.state.finished, updateTrip: this.getTripInfo, trip: this.state.trip, destinations: this.state.destinations }) : React.createElement(BlogCarousel, { showResults: this.state.showResults, onClick: this.onClick, lat: this.state.lat, long: this.state.long, posts: this.state.posts, newBlogPost: this.newBlogPost })
      )
    );
  }
...
var NewBlogPost = React.createClass({
  displayName: 'NewBlogPost',

  render: function () {
    return React.createElement(
      'div',
      null,
      React.createElement('input', { id: 'bloglatitude', type: 'hidden', name: 'post[latitude]', value: this.props.lat }),
      React.createElement('input', { id: 'bloglongitude', type: 'hidden', name: 'post[longitude]', value: this.props.long }),
      React.createElement('input', { id: 'blogtitle', type: 'text', name: 'post[title]', placeholder: 'Title' }),
      React.createElement('textarea', { id: 'blogcontent', cols: '20', name: 'post[content]', rows: '10', placeholder: 'What did you do today?' }),
      React.createElement(
        'button',
        { className: 'button small', onClick: this.props.newBlogPost },
        'Create Blog Post'
      )
    );
  }
...
var EditPost = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'form',
      { action: '/users/' + window.location.pathname.split('/')[2] + '/trips/' + window.location.pathname.split('/')[4] + '/posts/' + this.props.id, method: 'post' },
      React.createElement('input', { type: 'text', id: 'editTitle', name: 'post[title]', placeholder: this.props.title }),
      React.createElement(
        'textarea',
        { cols: '20', id: 'editContent', name: 'post[content]', rows: '10', placeholder: 'What did you do today?' },
        this.props.content
      ),
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'fi-pencil' }),
        ' Add new blog post'
      )
    );
  }
...
var NewDestinationButton = React.createClass({
  displayName: 'NewDestinationButton',
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        { onClick: this.onClick },
        React.createElement('span', { className: 'fi-pencil' }),
        ' Add a new trip destination'
      ),
      this.state.showResults ? React.createElement(NewDestinationForm, null) : null
    );
  }
});

var NewDestinationForm = React.createClass({
  displayName: 'NewDestinationForm',

  render: function () {
    return React.createElement(
      'form',
      { action: '/users/' + window.location.pathname.split('/')[2] + '/trips/' + window.location.pathname.split('/')[4] + '/destinations', method: 'post' },
      React.createElement('input', { type: 'hidden', name: '_method', value: 'post' }),
      React.createElement('input', { type: 'text', name: 'destination[name]', placeholder: 'City, State' }),
      React.createElement('input', { type: 'submit', value: 'Add Stop', className: 'button' })
    );
  }
});

var DisplayPosts = React.createClass({
  displayName: 'DisplayPosts',

  render: function () {
    var allPosts = this.props.posts;
    var displayPosts = [];
    for (var i = 0; i < allPosts.length; i++) {
      displayPosts.push(React.createElement(PostComponent, { key: allPosts[i].id, data: allPosts[i] }));
    }
    return React.createElement(
      'div',
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement('span', { className: 'fi-pencil' }),
        ' ',
        this.props.showResults ? "Show my blogs" : "Add new blog post"
      ),
      this.props.showResults ? React.createElement(NewBlogPost, { newBlogPost: this.props.newBlogPost, lat: this.props.lat, long: this.props.long }) : React.createElement(DisplayPosts, { posts: this.props.posts })
    );
  }
});
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'button',
          { className: 'button tiny', onClick: this.toggleForm },
          'EDIT'
        ),
        this.state.editForm ? React.createElement(EditPost, { className: 'editPost', key: data.id, id: data.id, title: data.title, content: data.content }) : React.createElement(
          'div',
          null,
          React.createElement(
            'h1',
...
var Itinerary = React.createClass({
  ...
  render: function () {
    ...
    return React.createElement(
      'div',
      { className: 'itinerary' },
      React.createElement(NewDestinationButton, null),
      React.createElement(
        'h1',
        null,
        trip.name
      ...
      React.createElement(
        'a',
        { href: 'https://www.google.com/maps/dir' + dest, target: '_blank', className: 'button tiny' },
        'Get Directions'
      ),
      React.createElement(
        'h3',
      ...
      this.props.destinations.map(function (e) {
        return React.createElement(ItineraryListing, { getTripInfo: this.props.updateTrip, name: e.name, events: e.events, destinationid: e.destinationid, placeid: e.place_id, lat: e.lat, lng: e.lng });
      }, this),
      React.createElement(
        'h3',
        null,
      ...
      React.createElement(
        ...
        { onClick: finished },
        ' ',
        this.props.finished ? "Finished!" : "Mark as Finished"
      )
    );
  }
});
  ...
  render: function () {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { id: 'loclat', className: 'hidden' },
          this.props.lat
        ),
        React.createElement(
          'div',
          { id: 'loclong', className: 'hidden' },
          this.props.long
        ),
        React.createElement('div', { id: 'destinationid', className: 'hidden' }),
        React.createElement('div', { id: 'category', className: 'hidden' })
      ),
      React.createElement(
        'div',
        ...
        React.createElement(
          'select',
          { className: 'small', id: 'range', name: 'range' },
          React.createElement(
            'option',
            { value: '1600' },
            '1'
        ...
        React.createElement(
          'select',
          { className: 'small', id: 'cat', name: 'category' },
          React.createElement(
            'option',
            { value: 'museum' },
            'Museums'
        ...
        this.props.destinations.map(function (e) {
          return React.createElement(Destination, { onClick: this.onClick, getTripInfo: this.props.updateTrip, name: e.name, events: e.events, destinationid: e.destinationid, placeid: e.place_id, lat: e.lat, lng: e.lng });
        }, this)
      ),
      React.createElement(
        'div',
        { className: 'large-8 columns' },
        React.createElement(PlacesForm, { getTripInfo: this.props.updateTrip })
      )
    );
  }
});
...
var Destination = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'h3',
        { className: 'destination', onClick: this.props.onClick.bind(this, this.props.lat, this.props.lng, this.props.destinationid, this.props.name) },
        this.props.name
      )
    );
  }
...
var ItineraryListing = React.createClass({
  ...
  render: function () {
    var eventList = this.props.events.map(function (e) {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('i', { className: eventIcons[e.category] }),
          '  ',
          e.name,
          '  '
        ),
        React.createElement(
          ...
          React.createElement(MoreInfoModalButton, { className: 'inline', placeid: e.place_id })
        ),
        React.createElement(
          'div',
          { className: 'large-2 columns' },
          React.createElement('i', { onClick: this.deleteEvent.bind(this, e.id), className: 'fa fa-close right' }),
          ' '
        )
      );
    }, this);
    return React.createElement(
      ...
      React.createElement(
        'h3',
        { className: 'itinerarylisting', onClick: this.onClick },
        this.props.name
      ),
      eventList
    );
...
var PlacesForm = React.createClass({
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'icon-bar three-up' },
        React.createElement(
          'a',
          { className: 'item', onClick: this.onClick.bind(this, this.props.lat, this.props.lng, "restaurant") },
          React.createElement(
            'label',
            null,
            'Food'
        ...
        React.createElement(
          'a',
          { className: 'item', onClick: this.onClick.bind(this, this.props.lat, this.props.lng, "lodging") },
          React.createElement(
            'label',
            null,
            'Hotels'
        ...
        React.createElement(
          'a',
          { className: 'item', onClick: this.onClick.bind(this, this.props.lat, this.props.lng, "museum") },
          React.createElement(
            'label',
            null,
            'Activities'
      ...
      React.createElement(PlacesResults, { getTripInfo: this.props.getTripInfo, results: this.state.searchResults })
    );
  }
});

var PlacesResults = React.createClass({
  displayName: 'PlacesResults',
  ...
  render: function () {
    if (this.props.results.data) {
      var listings = this.props.results.data.results.map(function (result) {
        return React.createElement(
          'div',
          { className: 'placesresult clear' },
          React.createElement(
            'div',
            { className: 'large-7 columns' },
            React.createElement(
              'button',
              { type: 'submit', onClick: this.saveEvent.bind(this, result.place_id, result.name), className: 'button tiny success' },
              'Save'
            ),
            React.createElement(MoreInfoModalButton, { className: 'inline', placeid: result.place_id })
          ),
          React.createElement(
            'div',
    ...
    return React.createElement(
      'div',
      { className: 'searchresultlistings' },
      listings
    );
  }
});
...
var MoreInfoModalButton = React.createClass({
  displayName: 'MoreInfoModalButton',
  ...
  render: function () {
    return React.createElement(
      ...
      React.createElement(
        'button',
        { onClick: this.handleClick, className: 'button tiny info' },
        'More Info'
      )
    );
  }
